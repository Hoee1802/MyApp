...
MediumScreenViewBase::MediumScreenViewBase() :
    flexButtonCallback(this, &MediumScreenViewBase::flexButtonCallbackHandler),
    interaction1Counter(0)
{
    ...
    start.setTypedText(touchgfx::TypedText(T___SINGLEUSE_3639));
    start.setAlpha(210);
    add(start);
    ...
    check1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_J6NI));
    check1.setAlpha(190);
    add(check1);
    ...
    check2.setTypedText(touchgfx::TypedText(T___SINGLEUSE_JC87));
    check2.setAlpha(190);
    add(check2);
}
...
void MediumScreenViewBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
    if (&src == &exit1)
    {
        //Interaction9
...
void MediumScreenViewBase::handleTickEvent()
{
...
void MediumScreenViewBase::afterTransition()
{
    //Interaction3
